...
export const DEFAULT_THEME_ID = "novaterm-default";
...
const STORE_PATH = "novaterm-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "novaterm://prefs-changed";
...
const KEYS_CHANGED_EVENT = "novaterm://ai-keys-changed";
