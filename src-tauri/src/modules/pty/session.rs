...
const AGENT_EVENT: &str = "novaterm:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[novaterm: dropped output due to backpressure]\x1b[0m\r\n";
...
pub fn spawn(
    ...
    thread::Builder::new()
        .name("novaterm-pty-flusher".into())
        .spawn(move || {
